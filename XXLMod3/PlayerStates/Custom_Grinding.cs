...
{
    public class Custom_Grinding : PlayerState_OnBoard
    {
        ...
        public Custom_Grinding(SplineComputer p_spline)
        {
            SoundManager.Instance.PlayGrindSound(PlayerController.Instance.boardController.isSliding ? 1 : PlayerController.Instance.boardController.GetGrindSoundInt(), Vector3.ProjectOnPlane(PlayerController.Instance.boardController.boardRigidbody.velocity, Vector3.up).magnitude);
        ...
        public override void Enter()
        {
            ...
            XXLController.Instance.ActivateSlowMotion(Main.settings.SlowMotionGrinds, Main.settings.SlowMotionGrindSpeed);
        }

        public override void Update()
        {
            base.Update();
            DefaultAnimationSpeed = Mathf.MoveTowards(DefaultAnimationSpeed, AnimationSpeed, 1f * Time.deltaTime);
            PlayerController.Instance.animationController.ScaleAnimSpeed(AnimationSpeed);
            DoStance();
        ...
        {
            XXLController.Instance.ResetTime(Main.settings.SlowMotionGrinds);
            if (isGrabbing)
            {
                ExitGrab();
            }
        ...
        private void DoStance()
        {
            switch (PlayerController.Instance.boardController.triggerManager.grindDetection.grindType)
            {
                case GrindType.BsBluntSlide:
                    ...
                    break;
                case GrindType.FsBluntSlide:
                    DoStance(StanceController.Instance.FSBluntslideFeet);
                    break;
                case GrindType.BsBoardSlide:
                    DoStance(StanceController.Instance.BSBoardslideFeet);
                    break;
                case GrindType.FsBoardSlide:
                    DoStance(StanceController.Instance.FSBoardslideFeet);
                    break;
                case GrindType.BsCrook:
                    DoStance(StanceController.Instance.BSCrookFeet);
                    break;
                case GrindType.FsCrook:
                    DoStance(StanceController.Instance.FSCrookFeet);
                    break;
                case GrindType.BsFeeble:
                    DoStance(StanceController.Instance.BSFeebleFeet);
                    break;
                case GrindType.FsFeeble:
                    DoStance(StanceController.Instance.FSFeebleFeet);
                    break;
                case GrindType.BsFiftyFifty:
                    DoStance(StanceController.Instance.BSFiftyFiftyFeet);
                    break;
                case GrindType.FsFiftyFifty:
                    DoStance(StanceController.Instance.FSFiftyFiftyFeet);
                    break;
                case GrindType.BsFiveO:
                    DoStance(StanceController.Instance.BSFiveOFeet);
                    break;
                case GrindType.FsFiveO:
                    DoStance(StanceController.Instance.FSFiveOFeet);
                    break;
                case GrindType.BsLipSlide:
                    DoStance(StanceController.Instance.BSLipslideFeet);
                    break;
                case GrindType.FsLipSlide:
                    DoStance(StanceController.Instance.FSLipslideFeet);
                    break;
                case GrindType.BsLosi:
                    DoStance(StanceController.Instance.BSLosiFeet);
                    break;
                case GrindType.FsLosi:
                    DoStance(StanceController.Instance.FSLosiFeet);
                    break;
                case GrindType.BsNoseBluntSlide:
                    DoStance(StanceController.Instance.BSNosebluntFeet);
                    break;
                case GrindType.FsNoseBluntSlide:
                    DoStance(StanceController.Instance.FSNosebluntFeet);
                    break;
                case GrindType.BsNoseGrind:
                    DoStance(StanceController.Instance.BSNosegrindFeet);
                    break;
                case GrindType.FsNoseGrind:
                    DoStance(StanceController.Instance.FSNosegrindFeet);
                    break;
                case GrindType.BsNoseSlide:
                    DoStance(StanceController.Instance.BSNoseslideFeet);
                    break;
                case GrindType.FsNoseSlide:
                    DoStance(StanceController.Instance.FSNoseslideFeet);
                    break;
                case GrindType.BsOverCrook:
                    DoStance(StanceController.Instance.BSOvercrookFeet);
                    break;
                case GrindType.FsOverCrook:
                    DoStance(StanceController.Instance.FSOvercrookFeet);
                    break;
                case GrindType.BsSalad:
                    DoStance(StanceController.Instance.BSSaladFeet);
                    break;
                case GrindType.FsSalad:
                    DoStance(StanceController.Instance.FSSaladFeet);
                    break;
                case GrindType.BsSmith:
                    DoStance(StanceController.Instance.BSSmithFeet);
                    break;
                case GrindType.FsSmith:
                    DoStance(StanceController.Instance.FSSmithFeet);
                    break;
                case GrindType.BsSuski:
                    DoStance(StanceController.Instance.BSSuskiFeet);
                    break;
                case GrindType.FsSuski:
                    DoStance(StanceController.Instance.FSSuskiFeet);
                    break;
                case GrindType.BsTailSlide:
                    DoStance(StanceController.Instance.BSTailslideFeet);
                    break;
                case GrindType.FsTailSlide:
                    DoStance(StanceController.Instance.FSTailslideFeet);
                    break;
                case GrindType.BsWilly:
                    DoStance(StanceController.Instance.BSWillyFeet);
                    break;
                case GrindType.FsWilly:
                    DoStance(StanceController.Instance.FSWillyFeet);
                    break;
            }
        }
        ...
        public override void OnRBDown()
        {
            ...
            SetHandIKTarget(GrabType.NoseGrab);
            rightIk = Mathf.MoveTowards(rightIk, 1f, Time.deltaTime * 3f);
            PlayerController.Instance.SetHandIKWeight(leftIk, rightIk);
        }
        ...
        public void SetHandIKTarget(GrabType grab)
        {
            if (SettingsManager.Instance.stance == Stance.Regular)
            {
                switch (grab)
                {
                    case GrabType.Indy:
                        PlayerController.Instance.ikController.currentRightGrabTarget.position = PlayerController.Instance.ikController.RIndy.position;
                        PlayerController.Instance.ikController.currentRightGrabTarget.rotation = PlayerController.Instance.ikController.RIndy.rotation;
                        return;
                    case GrabType.Melon:
                        PlayerController.Instance.ikController.currentLeftGrabTarget.position = PlayerController.Instance.ikController.RMelon.position;
                        PlayerController.Instance.ikController.currentLeftGrabTarget.rotation = PlayerController.Instance.ikController.RMelon.rotation;
                        return;
                    case GrabType.NoseGrab:
                        PlayerController.Instance.ikController.currentLeftGrabTarget.position = PlayerController.Instance.ikController.RNose.position;
                        PlayerController.Instance.ikController.currentLeftGrabTarget.rotation = PlayerController.Instance.ikController.RNose.rotation;
                        return;
                    case GrabType.TailGrab:
                        PlayerController.Instance.ikController.currentRightGrabTarget.position = PlayerController.Instance.ikController.RTail.position;
                        PlayerController.Instance.ikController.currentRightGrabTarget.rotation = PlayerController.Instance.ikController.RTail.rotation;
                        return;
                    case GrabType.Mute:
                        PlayerController.Instance.ikController.currentLeftGrabTarget.position = PlayerController.Instance.ikController.RMute.position;
                        PlayerController.Instance.ikController.currentLeftGrabTarget.rotation = PlayerController.Instance.ikController.RMute.rotation;
                        return;
                    case GrabType.Stalefish:
                        PlayerController.Instance.ikController.currentRightGrabTarget.position = PlayerController.Instance.ikController.RStale.position;
                        PlayerController.Instance.ikController.currentRightGrabTarget.rotation = PlayerController.Instance.ikController.RStale.rotation;
                        return;
                    default:
                        return;
                }
            ...
            else
            {
                ...
                {
                    case GrabType.Indy:
                        PlayerController.Instance.ikController.currentLeftGrabTarget.position = PlayerController.Instance.ikController.GIndy.position;
                        PlayerController.Instance.ikController.currentLeftGrabTarget.rotation = PlayerController.Instance.ikController.GIndy.rotation;
                        return;
                    case GrabType.Melon:
                        PlayerController.Instance.ikController.currentRightGrabTarget.position = PlayerController.Instance.ikController.GMelon.position;
                        PlayerController.Instance.ikController.currentRightGrabTarget.rotation = PlayerController.Instance.ikController.GMelon.rotation;
                        return;
                    case GrabType.NoseGrab:
                        PlayerController.Instance.ikController.currentRightGrabTarget.position = PlayerController.Instance.ikController.GNose.position;
                        PlayerController.Instance.ikController.currentRightGrabTarget.rotation = PlayerController.Instance.ikController.GNose.rotation;
                        return;
                    case GrabType.TailGrab:
                        PlayerController.Instance.ikController.currentLeftGrabTarget.position = PlayerController.Instance.ikController.GTail.position;
                        PlayerController.Instance.ikController.currentLeftGrabTarget.rotation = PlayerController.Instance.ikController.GTail.rotation;
                        return;
                    case GrabType.Mute:
                        PlayerController.Instance.ikController.currentRightGrabTarget.position = PlayerController.Instance.ikController.GMute.position;
                        PlayerController.Instance.ikController.currentRightGrabTarget.rotation = PlayerController.Instance.ikController.GMute.rotation;
                        return;
                    case GrabType.Stalefish:
                        PlayerController.Instance.ikController.currentLeftGrabTarget.position = PlayerController.Instance.ikController.GStale.position;
                        PlayerController.Instance.ikController.currentLeftGrabTarget.rotation = PlayerController.Instance.ikController.GStale.rotation;
                        return;
                    default:
                        return;
                }
